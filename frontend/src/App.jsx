...
function AuthScreen({ setToken, initialMode }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://code-mentor-pi.vercel.app${endpoint}`, {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    setLoading(true); setError('');
    try {
      const response = await fetch('https://code-mentor-pi.vercel.app/api/google-login', {
        method: 'POST', headers: { 'Content-Type': 'application/json' },
...
function Dashboard({ token, setToken }) {
  ...
  const submitCode = async () => {
    ...
    try {
      const response = await fetch('https://code-mentor-pi.vercel.app/api/review', {
        method: 'POST',
...
function ProblemTracker({ token, setToken }) {
  ...
  const fetchProblems = async () => {
    try {
      const response = await fetch('https://code-mentor-pi.vercel.app/api/problems', { headers: { 'Authorization': `Bearer ${token}` } });
      const data = await response.json();
  ...
  const handleAddProblem = async (e) => {
    ...
    try {
      const response = await fetch('https://code-mentor-pi.vercel.app/api/problems', {
  ...
  const updateStatus = async (id, newStatus) => {
    try {
      await fetch(`https://code-mentor-pi.vercel.app/api/problems/${id}`, {
  ...
  const deleteProblem = async (id) => {
    try {
      await fetch(`https://code-mentor-pi.vercel.app/api/problems/${id}`, { method: 'DELETE', headers: { 'Authorization': `Bearer ${token}` } });
      fetchProblems();
    } catch (err) { console.error(err); }
  };
...
function HistoryDashboard({ token, setToken }) {
  ...
  useEffect(() => {
    const fetchHistory = async () => {
      try {
        const response = await fetch('https://code-mentor-pi.vercel.app/api/history', { headers: { 'Authorization': `Bearer ${token}` } });
        const data = await response.json();
